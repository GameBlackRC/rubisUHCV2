...
public class Raptor {
	...
	public static void Texte(Player player) {
        ...
        player.sendMessage("____________________________________________________\n \nVous êtes §aRaptor\n§rVous devez gagner avec le §acamp joueur§r\n \nA l'annonce des rôles, vous recevez un item nommé 'Rage' vous permettant de recevoir 15% de force pendant 1 minute. A la fin du pouvoir, vous recevrez l'effet Nausée I pendant 20 secondes. Lorsque vous subissez 5 coup du même adversaire sans l'avoir toucher, vous activer un cheat qui vous donne un avantage parmi les suivant aléatoirement :\n- 10% de chance de rien recevoir\n- 10% de chance d'avoir un anti-kb pendant 5 secondes\n- 15% de chance de recevoir 10% de force supplémentaire pendant 1 minute\n- 20% de chance de recevoir 5% de force supplémentaire pendant 1 minute\n- 20% de chance de recevoir 5% de resistance supplémentaire pendant 1 minute\n- 25% de chance de recevoir 10% de speed supplémentaire pendant 1 minute\n \n____________________________________________________");
