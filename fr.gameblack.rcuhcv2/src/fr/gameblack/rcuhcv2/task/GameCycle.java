...
public class GameCycle extends BukkitRunnable {
    ...
    public static void setRole(Main main) {
        ...
        if(main.getCompo().contains(Roles.OBSCUR) && main.getCompo().contains(Roles.TOINOU)) {
        	...
        	obscur.getPlayer().sendMessage("Toinou n'étant pas dans la compo, vous recevez 2% de force permanent");
    ...
    public static void ScoreboardBase(Main main, int timer, Roles role, Objective objective) {
        ...
        Score score3 = objective.getScore("Role: " + j.getCouleurCamp() + j.getRole().getTxt());
        score3.setScore(6);
        Score score4;
    ...
    public void run() {
    	...
    	if(main.getJoueurByRole(Roles.TOINOU) != null) {
    		...
    		if(toinou.getPlayer().getItemInHand() == nuage && !toinou.isBonusToinouNuage()) {
    			
    			toinou.addSpeed(0.05);
    			toinou.setBonusToinouNuage(true);
    			
    		}
    		else if(toinou.getPlayer().getItemInHand() != nuage && toinou.isBonusToinouNuage()){
    		...
    		if(toinou.getPlayer().getItemInHand() == maudit && !toinou.isBonusToinouMaudit()) {
    			
    			toinou.addForce(0.02);
    			toinou.setBonusToinouMaudit(true);
    			
    		}
    		else if(toinou.getPlayer().getItemInHand() != maudit && toinou.isBonusToinouMaudit()){
