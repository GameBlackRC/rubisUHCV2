    ...
    public void run() {
        ...
        if (main.getCampsRCVie().contains(Roles.ECLAIREUR) || (main.getCampsDemonVie().contains(Roles.TRIAL) && main.getVolTrial().contains("invisible_eclaireur"))) {
            ...
            if (eclaireur.getInventory().getBoots() == null && eclaireur.getInventory().getChestplate() == null && eclaireur.getInventory().getHelmet() == null && eclaireur.getInventory().getLeggings() == null) {
                ...
                if (!eclaireur.hasPotionEffect(PotionEffectType.INVISIBILITY))
                    eclaireur.addPotionEffect(new PotionEffect(PotionEffectType.INVISIBILITY, 999999, 0, false, false));
                if (!eclaireur.hasPotionEffect(PotionEffectType.WEAKNESS))
                    eclaireur.addPotionEffect(new PotionEffect(PotionEffectType.WEAKNESS, 99999, 0, false, false));

            } else {

                if (eclaireur.hasPotionEffect(PotionEffectType.INVISIBILITY))
                    eclaireur.removePotionEffect(PotionEffectType.INVISIBILITY);
                if (eclaireur.hasPotionEffect(PotionEffectType.WEAKNESS))
                    eclaireur.removePotionEffect(PotionEffectType.WEAKNESS);
        ...
        for (int i = 0; i < main.getPlayers().size(); i++) {
            ...
            if (!main.isDay()) {
                ...
                if (main.getRoles().contains(Roles.RAPTOR) && main.getRole(main.getPlayers().get(i)) == Roles.RAPTOR) {
                    ...
                    if (!main.getPlayers().get(i).hasPotionEffect(PotionEffectType.DAMAGE_RESISTANCE))
                        main.getPlayers().get(i).addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 99999, 0, false, false));

                } else if (main.getRoles().contains(Roles.MAKA) && main.getRole(main.getPlayers().get(i)) == Roles.MAKA) {

                    if (main.getPlayers().get(i).hasPotionEffect(PotionEffectType.SPEED))
                        main.getPlayers().get(i).removePotionEffect(PotionEffectType.SPEED);
                    ...
                    if (main.getPlayers().get(i).hasPotionEffect(PotionEffectType.DAMAGE_RESISTANCE))
                        main.getPlayers().get(i).removePotionEffect(PotionEffectType.DAMAGE_RESISTANCE);
                ...
                if (main.getRoles().contains(Roles.TRIAL) && main.getRole(main.getPlayers().get(i)) == Roles.TRIAL) {
                    ...
                    if (main.getPlayers().get(i).hasPotionEffect(PotionEffectType.INCREASE_DAMAGE))
                        main.getPlayers().get(i).removePotionEffect(PotionEffectType.INCREASE_DAMAGE);
                    ...
                    if (!main.getPlayers().get(i).hasPotionEffect(PotionEffectType.SPEED))
                        main.getPlayers().get(i).addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 99999, 0, false, false));

                } else if (main.getRoles().contains(Roles.TENEBRE) && main.getRole(main.getPlayers().get(i)) == Roles.TENEBRE) {

                    if (main.getPlayers().get(i).hasPotionEffect(PotionEffectType.INCREASE_DAMAGE))
                        main.getPlayers().get(i).removePotionEffect(PotionEffectType.INCREASE_DAMAGE);
                    if (!main.getPlayers().get(i).hasPotionEffect(PotionEffectType.WEAKNESS))
                        main.getPlayers().get(i).addPotionEffect(new PotionEffect(PotionEffectType.WEAKNESS, 99999, 0, false, false));
                    if (main.getPlayers().get(i).hasPotionEffect(PotionEffectType.DAMAGE_RESISTANCE))
                        main.getPlayers().get(i).removePotionEffect(PotionEffectType.DAMAGE_RESISTANCE);
                    ...
                    if (main.isSpeedFarmeur()) {
                        ...
                        if (!main.getPlayers().get(i).hasPotionEffect(PotionEffectType.SPEED))
                            main.getPlayers().get(i).addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 99999, 1, false, false));
